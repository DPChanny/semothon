...
class _InterestCategorySelectionPageState extends State<InterestCategorySelectionPage> {
  final Map<String, List<String>> keywords = {
    '미술': [
      ...
      '공간디자인', '웹툰 & 디자인', '조형', '순수디자인', '회화',
      '서양화', '동양화'
    ],
    '음악': [
      '성악', '기악', '작곡', '실용음악', '지휘', '음악교육', '뮤지컬', '음향디자인'
    ],
    '체육': [
      '체육학', '스포츠과학', '무용', '무예', '레저스포츠', '생활체육', '재활운동', '스포츠의학'
    ],
    '디자인': [
      '산업디자인', '시각디자인', '패션디자인', '콘텐츠 디자인',
      'UX/UI', '공간디자인', '조형디자인', '인터랙션디자인'
    ],
  };
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  Container(height: 4, width: MediaQuery.of(context).size.width * 0.66, color: const Color(0xFF008CFF)),
                ],
              ),
              const SizedBox(height: 24),
              const Text(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: isExpanded ? const Color(0xFFF5F5F5) : Colors.transparent,
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: selectedKeywords.isNotEmpty ? const Color(0xFF008CFF) : const Color(0xFFE4E4E4),
                      shape: RoundedRectangleBorder(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: FontWeight.w700,
                        fontFamily: 'Noto Sans KR',
                        color: selectedKeywords.isNotEmpty ? Colors.white : const Color(0xFFB1B1B1),
                      ),
                    ),
                  ),
                ),
