...
@router.post("/ai/recommend/room/by-user", response_model=RecommendResponseDTO)
...
@router.post("/ai/recommend/room/by-room", response_model=RecommendResponseDTO)
def recommend_room_by_room_route(
    request: RecommendRoomByRoomRequestDTO,
    db: Session = Depends(get_db)):
        return recommend_room_by_room_service(request, db)

@router.post("/ai/recommend/crawling/by-user", response_model=RecommendResponseDTO)
...
@router.post("/ai/recommend/crawling/by-crawling", response_model=RecommendResponseDTO)
